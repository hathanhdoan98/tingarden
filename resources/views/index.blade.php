@extends('layout.app')
@section('content')
    <section class="swiper-containerslide p-relative">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="" class="max-img v-img" title="Hasu Flora with love">
                    <img class="col-100"
                         src="resize/1440x605/1/upload/hinhanh/6960bb6b769c84c2dd8d-1524.jpg"
                         alt="Hasu Flora with love" onerror="this.src='images/no-image.jpg'" />
                </a>
            </div>
            <div class="swiper-slide">
                <a href="" class="max-img v-img" title="Summer Time">
                    <img class="col-100"
                         src="resize/1440x605/1/upload/hinhanh/fca59fae5259a007f948-2955.jpg"
                         alt="Summer Time" onerror="this.src='images/no-image.jpg'" />
                </a>
            </div>
        </div>
    </section>
    <section class="section-product-hot pt-30 clearfix">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="title-default t-center p-relative">
                        <div><a href="san-pham" title="Sản phẩm nổi bật">Sản phẩm nổi bật</a></div>
                    </div>
                    <div class="row mt-30">
