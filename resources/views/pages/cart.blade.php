                                        ...
                                        <div class="content-cart mt-20">
                                                    ...
                                                    <tbody bgcolor="#fff"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" width="15%"
                                                                ...
                                                                valign="center"><span>1.290.000 đ</span>
                                                            </td>
                                                            <td align="center" width="15%"
                                                    ...
                                                    <tfoot
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right"
                                                                style="padding:5px 9px;font-size:14px;color:#000"><span
                                                                    class="price-temp">2.580.000 đ</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" colspan="4" style="padding:7px 9px">
                                                        ...
                                                        <tr bgcolor="#fff">
                                                            ...
                                                            <td align="right"
                                                                ...
                                                                <strong><big><span id="total-cart">2.580.000 đ</span>
                                                                    </big> </strong>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                            ...
                                            <div class="button-block ds-mobile mt-10">
                                                <a class="step-footer-previous-link" href="san-pham"
                                                    style="color: #338dbc;">
                                                    <button type="submit"
                                                        class="btn btn--buy-now btn--buy-now-x2 w-100i">Tiếp tục mua
                                                        hàng&nbsp;&nbsp;<i class="fa fa-caret-right"
                                                ...
                                                <button class="w-100i"
                                                    ...
                                                    id="giohang" title="thanh toán">Giao hàng & thanh toán</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <tbody bgcolor="#fff"
                                                            ...
                                                            <tr>
                                                                <td align="left" width="30%"
                                                                    ...
                                                                    valign="center"><span>BÌNH HOA CARAMEL HBI - 024</span>
                                                                </td>
                                                                <td align="center" width="15%"
                                                                    style="padding:20px 9px; width:100px;border: 1px solid #ccc;"
                                                                    valign="center"><span class="v-img">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <div class="mt-20 t-right">
                                                    <button type="submit" id="xacnhan2"
                                                        class="btn btn--buy-now btn--buy-now-x2">Hoàn
                                                        tất&nbsp;&nbsp;<i class="fa fa-caret-right"
                                                            aria-hidden="true"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="step-content-item step-item-4">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="info-order mt-30">
                                                ...
                                                <p>Thông tin chi tiết đơn hàng sẽ được gửi đến hộp thư của bạn:<b
                                                        id="order-email"></b></p>
                                            </div>
                                            ...
                                            <div class="info-order mt-30">
                                                <p>Cảm ơn bạn đã đặt hàng. Đơn hàng của bạn sẽ được xử lý trong thời gian
                                                    sớm nhất</p>
                                            ...
                                            <div class="row-cart t-right mt-10">
                                                <a href="san-pham" title="sản phẩm"><button type="submit"
                                                        class="btn btn--buy-now btn--buy-now-x2">Tiếp tục mua
                                                        hàng&nbsp;&nbsp;<i class="fa fa-caret-right"
