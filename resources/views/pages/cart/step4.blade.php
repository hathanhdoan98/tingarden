<div class="step-content-item step-item-4">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="row-cart t-right mt-10">
            <a href="san-pham" title="sản phẩm"><button type="submit" class="btn btn--buy-now btn--buy-now-x2">Tiếp tục mua
                    hàng&nbsp;&nbsp;<i class="fa fa-caret-right" aria-hidden="true"></i></button></a>
        </div>
    </div>
</div>