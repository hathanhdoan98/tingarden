...
@section('content')
    ...
    <div class="row" id="object-post" api-list="{{route('admin.post.get_list')}}"
         api-create="{{route('admin.post.create')}}" api-get-item="{{ route('admin.post.get_post') }}"
         api-update="{{ route('admin.post.update') }}">
                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        <template v-if="data != ''">
                            <tr v-for="(item, index) in data">
                                ...
                                <td> @{{sumarizeContent(item.name)}}</td>
...
@section('script')
    <script>
        ...
        var page = new objectPost('#object-post');

        function objectPost(element) {
