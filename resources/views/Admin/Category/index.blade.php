...
@section('content')
    ...
    {{-- </nav>--}}
    {{-- </div>--}}
    <div class="row" id="object-category" api-list="{{route('admin.category.get_list')}}"
         api-create="{{route('admin.category.create')}}"
         api-get-item="{{ route('admin.category.get_category') }}" api-update="{{ route('admin.category.update') }}"
         >
                                    ...
                                    <div class="row" id="form-create-user">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <ckeditor v-model="data_create.description"></ckeditor>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('script')
    <script>
        var category = new objectCategory('#object-category');

        function objectCategory(element) {
            // Vue.use(VeeValidate, {
            //     locale: 'vi',
