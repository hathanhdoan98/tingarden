...
"use strict";
/*!*********************************************!*\
  !*** ./resources/js/admin/pages/setting.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _common_helper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/helper.js */ "./resources/js/common/helper.js");
...
$(document).delegate('.btn-add', 'click', function (e) {
  ...
  var successCallback = function successCallback(response) {
    (0,_common_helper_js__WEBPACK_IMPORTED_MODULE_2__.showNotification)('Cập nhật thành công', 'success');
  };

  var failCallback = function failCallback(response) {
    response = response.responseJSON;
    var message = response.message ? response.message : 'Thất bại';
    message = (0,_create_data_js__WEBPACK_IMPORTED_MODULE_1__.getResponseMessage)(message);
    (0,_common_helper_js__WEBPACK_IMPORTED_MODULE_2__.showNotification)(message, 'danger');
  };
  ...
  (0,_common_ajax_js__WEBPACK_IMPORTED_MODULE_0__.sendRequest)('POST', {
    'settings': settings
  }, apiUpdate, successCallback, failCallback);
});
})();
